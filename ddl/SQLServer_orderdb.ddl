...
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ('Assembly Architecture', 1, 'Gear up for Assembly Architecture, where you''ll step behind the scenes of computer systems and explore the MIPS architecture through assembly programming. Unlock the secrets of performance optimization and real-time system design - it''s time to assemble your understanding! (Based on COSC 211)', 600);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ('Computer Creativity', 1, 'Unleash your inner coder in Computer Creativity, where programming meets imagination! You’ll explore the world of graphics, events, and 2D games while practicing the basics of decision-making and iteration. Ready to code your own masterpiece? (Based on COSC 123)', 600);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ('Covariance Conundrum', 3, 'Welcome to the Covariance Conundrum, where probability and random variables come to life in a thrilling quest! Tackle discrete and continuous distributions, joint probabilities, and transformations like a true statistical hero, all while unlocking the secrets of calculus. (Based on STAT 303)', 600);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ('Database Dynasty', 1, 'Step into Database Dynasty, where you’ll build, query, and conquer the kingdom of data! From mastering SQL and designing powerful databases with ER diagrams to automating data analysis, become the ruler of relational databases. Ready to claim your database crown? (Based on COSC 304)', 600);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ('Hashmap Simulator', 1, 'Join the Hashmap Simulator, where data structures meet strategy! Dive deep into the world of Java and explore how to efficiently organize and access information in limited memory – because in the world of programming, efficiency is key! Ready to hash it out? (Based on COSC 222)', 600);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ('Integration Sensation', 2, 'Feel the Integration Sensation as you explore the world of integrals and their powerful applications! From mastering definite integrals to solving linear ODEs, you’ll learn how to apply integration techniques in ways that make modeling and real-world problems a breeze. (Based on MATH 101)', 600);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ('Matrix Mayhem', 2, 'Prepare for Matrix Mayhem, where linear algebra gets turned into a wild adventure! Battle through LU-factorization, QR-factorization, and eigenvalue estimates, while navigating the chaotic world of dynamical systems and orthogonality – all in the name of mastering the matrix! (Based on MATH 307)', 600);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ('Object Oriented Odyssey', 1, 'Embark on an Object Oriented Odyssey where you''ll master the art of Java programming! Learn to create powerful, reusable programs using concepts like encapsulation, inheritance, and polymorphism, while tackling exceptions, streams, and recursion along the way. Ready to code like a pro? (Based on COSC 121)', 600);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ('Sigma Statistics', 3, 'Get ready for Sigma Statistics, where data analysis and real-world application meet! From hypothesis testing and regression analysis to diving into the world of variance and non-parametrics, this course will give you the tools to turn numbers into meaningful insights. (Based on STAT 230)', 600);

INSERT INTO warehouse(warehouseName) VALUES ('Main warehouse');
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (1, 1, 5, 600);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (2, 1, 10, 600);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (3, 1, 3, 600);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (4, 1, 2, 600);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (5, 1, 6, 600);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (6, 1, 3, 600);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (7, 1, 1, 600);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (8, 1, 0, 600);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (9, 1, 2, 600);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (10, 1, 3, 600);
...
-- Will need to update these values later, as they do not reflect the new products.
...
UPDATE Product SET productImageURL = 'images/object_oriented_odyssey.jpg' WHERE ProductId = 9;
