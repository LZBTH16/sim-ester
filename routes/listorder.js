    ...
    **/
    ...
    (async function() {
        try {
            ...
            let sqlQuery = "SELECT orderId, orderDate, customerId, firstName, lastName, totalAmount FROM ordersummary JOIN customer ON customer.customerId = ordersummary.customerId";
            ...
            for (let i = 0; i < results.recordset.length; i++) {
                ...
                res.write("<tr><td>" + result.orderId + "</td><td>" + result.orderDate + "</td><td>" + result.customerId + "</td><td>" + result.firstName + result.lastName + "</td><td>" + result.totalAmount + "</td></tr>");
